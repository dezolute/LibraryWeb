...
class RequestService:
    ...
    async def get_multi(self, pg: Pagination, **kwargs) -> List[RequestDTO]:
        ...
        return [RequestDTO.model_validate(row) for row in requests]

    async def get_single(self, request_id: int):
